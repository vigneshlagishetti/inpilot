            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-sm mx-auto mb-8">
              ...
              >
                ...
                <div className="relative z-10">
                  <Mic className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1 sm:mb-2 text-blue-500 dark:text-blue-400 group-hover:scale-110 transition-transform duration-300" />
              ...
              >
                ...
                <div className="relative z-10">
                  <Brain className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1 sm:mb-2 text-purple-500 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300" />
              ...
              >
                ...
                <div className="relative z-10">
                  <Zap className="w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1 sm:mb-2 text-yellow-500 dark:text-yellow-400 group-hover:scale-110 transition-transform duration-300" />
